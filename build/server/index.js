...
import { ServerRouter, UNSAFE_withComponentProps, useLoaderData, Meta, Links, Outlet, ScrollRestoration, Scripts, redirect, UNSAFE_withErrorBoundaryProps, useRouteError, useFetcher, Link } from "react-router";
...
const action = async ({
  ...
  if (intent === "cancel_subscription") {
    try {
      const subsResp = await admin.graphql(`query ActiveSubscriptions {
          currentAppInstallation {
            activeSubscriptions { id }
          }
        }`);
      const subsData = await subsResp.json();
      const activeSubscriptions = ((_d = (_c = subsData.data) == null ? void 0 : _c.currentAppInstallation) == null ? void 0 : _d.activeSubscriptions) || [];
      for (const sub of activeSubscriptions) {
        const cancelResp = await admin.graphql(`mutation AppSubscriptionCancel($id: ID!) {
        ...
        const userErrors = (_f = (_e = cancelData.data) == null ? void 0 : _e.appSubscriptionCancel) == null ? void 0 : _f.userErrors;
        if (userErrors == null ? void 0 : userErrors.length) return {
          error: userErrors[0].message
        };
      }
      await prisma.$transaction([prisma.shop.update({
        where: {
          shop
        },
        data: {
      ...
      }), prisma.managedCollection.updateMany({
        where: {
          shop
        },
        data: {
...
const app__index = UNSAFE_withComponentProps(function Dashboard() {
  ...
  return /* @__PURE__ */ jsxs("s-page", {
    ...
    children: [!subscribed && /* @__PURE__ */ jsxs("s-banner", {
      ...
      children: compatible.length === 0 ? /* @__PURE__ */ jsxs("div", {
        children: [/* @__PURE__ */ jsxs("p", {
          style: {
            color: C.textSecondary,
            marginBottom: 12
          },
          children: ["DownStock only manages collections set to ", /* @__PURE__ */ jsx("strong", {
            children: "Manual"
          }), " sorting — that's a Shopify requirement, not a DownStock limit, and it means we'll never silently change how a collection is sorted for you."]
        }), /* @__PURE__ */ jsxs("ol", {
          style: {
            margin: "0 0 14px",
            paddingLeft: 18,
          ...
          children: [/* @__PURE__ */ jsx("li", {
            children: "Open a collection in Shopify admin"
          }), /* @__PURE__ */ jsxs("li", {
            children: ["Set its ", /* @__PURE__ */ jsx("strong", {
              children: "Sort"
            }), " option to ", /* @__PURE__ */ jsx("strong", {
              children: '"Manual"'
            }), " and save"]
          }), /* @__PURE__ */ jsxs("li", {
            children: ["Come back here and refresh — it'll show up below with an ", /* @__PURE__ */ jsx("strong", {
              children: "Enable"
            }), " button"]
          })]
        }), /* @__PURE__ */ jsx("a", {
          ...
          children: "Open Collections in Shopify admin →"
        })]
      }) : /* @__PURE__ */ jsxs("div", {
        children: [/* @__PURE__ */ jsxs("p", {
          style: {
          ...
          children: ["Click ", /* @__PURE__ */ jsx("strong", {
            children: "Enable"
          }), " on a collection to scan it now and keep it sorted automatically from then on — available products first, sold-out ones pushed to the bottom, both groups keeping their existing order."]
        }), /* @__PURE__ */ jsx("div", {
          style: {
            display: "flex",
    ...
    }), subscribed && /* @__PURE__ */ jsx("s-section", {
      ...
      children: /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          children: [/* @__PURE__ */ jsx("span", {
            ...
            children: inTrial && !isActive ? "Free trial" : "Active"
          }), /* @__PURE__ */ jsx("span", {
            style: {
              marginLeft: 10,
              fontSize: 13,
            ...
            children: "$1.99/month — cancel any time, no long-term commitment."
          })]
        }), /* @__PURE__ */ jsx(CancelSubscriptionControl, {
          fetcher
        })]
      })
    })]
...
function CancelSubscriptionControl({
  fetcher
}) {
  ...
  if (!confirming) {
    return /* @__PURE__ */ jsx("button", {
      ...
      style: {
        ...
        color: C.textCritical,
        border: `1px solid ${C.borderCritical}`,
        borderRadius: 8,
        fontSize: 13,
        cursor: "pointer"
      },
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx("span", {
      ...
      children: "Cancel and stop managing collections?"
    }), /* @__PURE__ */ jsxs(fetcher.Form, {
      method: "post",
      ...
      children: [/* @__PURE__ */ jsx("input", {
        ...
        children: busy ? "Cancelling…" : "Yes, cancel"
      })]
    }), /* @__PURE__ */ jsx("button", {
      type: "button",
